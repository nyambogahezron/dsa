...
export default {
	containsDuplicateSetSize,
	containsDuplicateHashSet,
	containsDuplicateSorting,
}

// Tests
console.log('[1,2,3,1] =>', containsDuplicateSetSize([1, 2, 3, 1]))
console.log('[1,2,3,4] =>', containsDuplicateSetSize([1, 2, 3, 4]))
console.log(
	'[1,1,1,3,3,4,3,2,4,2] =>',
	containsDuplicateSetSize([1, 1, 1, 3, 3, 4, 3, 2, 4, 2]),
)
console.log('[1,2,3,1] =>', containsDuplicateHashSet([1, 2, 3, 1]))
